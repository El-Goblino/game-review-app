...
export default function Article(props) {
    return (
        <div className="py-5 md:py-10 mx-auto px-5 space-y-5 flex flex-col md:w-4/5 lg:w-3/5 bg-neutral-200"> 
            {/* Return */}
            <div id="articleReturn" className="flex flex-row space-x-2">
                <Link to="/" className="text-red-500">Home</Link>
                    <svg className="h-4 mt-[0.3rem]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 512">{/*Attribution: ! Font Awesome Pro 6.1.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc.*/}
                        <path d="M64 448c-8.188 0-16.38-3.125-22.62-9.375c-12.5-12.5-12.5-32.75 0-45.25L178.8 256L41.38 118.6c-12.5-12.5-12.5-32.75 0-45.25s32.75-12.5 45.25 0l160 160c12.5 12.5 12.5 32.75 0 45.25l-160 160C80.38 444.9 72.19 448 64 448z"/>
                    </svg>
                <Link to="/reviews" className="text-red-500">Reviews</Link>
            </div>
            ...
            <div className="flex flex-row items-center justify-between px-10 pt-5 border-t-2 border-red-500">
                ...
                <h2 className="bg-green-500 text-white py-1.5 px-3 rounded-md">{props.metacriticScore}</h2>
            </div>
            ...
            <div className="flex flex-row items-center justify-between px-10">
                ...
                <h2 className="bg-green-500 text-white py-1.5 px-3 rounded-md whitespace-nowrap">{props.steamScore}</h2>
            </div>

            <div className="flex flex-row items-center justify-between px-10 pb-5 border-b-2 border-red-500">
                <h1 className="font-bold hover:text-red-500">My Score:</h1>

                <h2 className="bg-green-500 text-white py-1.5 px-3 rounded-md">{props.score}</h2>
            </div>
