...
export default function Featured() {
    return (
        <div>
            <h1 class="font-bold text-white mt-5 md:mt-9 bg-red-500 px-2 md:w-3/5 md:m-auto">Featured</h1>
            {/* Thumbnails */}
            <div class="flex flex-col">
                <div class="my-1 px-1 flex flex-col md:w-3/5 md:m-auto">
                ...
                <div class="md:flex md:flex-row md:m-auto md:my-4 md:justify-center md:space-x-3 md:w-3/5">
