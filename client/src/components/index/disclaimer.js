...
export default function Disclaimer() {
    return (
        ...
        <p class="-mt-[19.5rem] md:-mt-72 text-xs px-2">
            ...
            For any discrepancies please contact me <a class="text-xs underline" href="https://mail.google.com/mail/?view=cm&fs=1&to=joshhaywood025@gmail.com">here.</a>
        </p>
    );
};